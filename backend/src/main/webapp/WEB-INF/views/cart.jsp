...
<div class="container-wrapper">
    <div class="container">
        ...
        <section class="container" ng-app="myApp">
            ...
            <div ng-controller = "cartCtrl as ctrl" ng-init="initCartId('${cartId}')">

                <div> 	
                    <a class="btn btn-danger pull-left" ng-click = "clearCart()"><span class="glyphicon glyphicon-remove-sign"></span> Clear Cart</a>
                    <a href="http://localhost:8087/backend/memberShip?execution=e8s1" class="btn btn-success pull-right"><span class="glyphicon glyphicon-shopping-cart"></span> Check out</a>
